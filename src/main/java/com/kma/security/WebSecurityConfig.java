               ...
               // .cors(AbstractHttpConfigurer::disable)
                ...
                .authorizeHttpRequests(requests -> requests
                        ...
                        .requestMatchers(DELETE, "/image/**").permitAll()
                         .requestMatchers(PUT,
                                        String.format("%s/*/reset_password/**", userPrefix)).permitAll()
                        .requestMatchers(GET,
...
//                                ("/downloadFile/**")).hasAnyRole(Role.ADMIN, Role.STUDENT, Role.EMPLOYEE)
                        ...
                        .requestMatchers(GET, "/api/nhanvien/**").permitAll()
                                .requestMatchers(GET,"/api/training-programs/**").permitAll()
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        configuration.setAllowedOrigins(List.of("http://localhost:3000", "https://fe-webcntt.onrender.com"));
